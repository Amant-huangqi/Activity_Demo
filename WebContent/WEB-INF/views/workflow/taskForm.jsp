		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
			      ...
			      <c:forEach items="${commentList }" var="ani">
			        <tr>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><fmt:formatDate value="${ani.time}" pattern="yyyy/MM/dd  HH:mm:ss"/></div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.userId }</div></td>
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.fullMessage }</div></td>
				    </tr> 
			      </c:forEach>
			    </table></td>
			  </tr>
