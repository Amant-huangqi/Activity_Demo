	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:forEach var="ani" items="${taskList }">
		        <tr>
			        ...
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><fmt:formatDate value="${ani.createTime }" pattern="yyyy/MM/dd  HH:mm:ss" /> </div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.assignee }</div></td>
			        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
			        	<a href="${pageContext.request.contextPath }/workflowAction_viewTaskForm.action?taskId=${ani.id }">办理任务</a>
						<a target="_blank" href="workflowAction_viewCurrentImage.action?taskId=${ani.id }">查看当前流程图</a>
			        </div></td>
			    </tr> 
		      </c:forEach>
		    </table></td>
