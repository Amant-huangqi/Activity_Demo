	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:forEach var="ani" items="${depList}">
		        <tr>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.id}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.name}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><fmt:formatDate value="${ani.deploymentTime}" pattern="yyyy/MM/dd  HH:mm:ss" /></div></td>
			        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
			        	<a href="workflowAction_delDeployment.action?deploymentId=${ani.id}">删除</a>
			        </div></td>
			    </tr> 
		     </c:forEach>
		    </table></td>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:forEach var="ani" items="${pdList}">
		        <tr>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.id}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.name}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${ani.key}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.version}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.resourceName}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.diagramResourceName}</div></td>
			        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center">${ani.deploymentId}</div></td>
			        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
			        	<a target="_blank" href="workflowAction_viewImage.action?deploymentId=${ani.deploymentId}&imageName=${ani.diagramResourceName}">查看流程图</a> 
				 	</div></td>
			    </tr> 
		      </c:forEach>
		    </table></td>
